...
(function(document, $, Coral) {
    ...
    var selectors = {
        dialogContent: ".cmp-embeddable-vimeo__editor",
        radioGroup: "[data-cmp-vimeo-dialog-edit='radioGroup']",
        radioInput: "[data-cmp-vimeo-dialog-edit='radioGroup'] coral-radio",
        layoutOption: "[data-cmp-vimeo-dialog-layout-option]"
    };
    ...
    function toggleLayoutOptions(value) {
        ...
        for (var i = 0; i < layoutOptions.length; i++) {
            var optionValue = layoutOptions[i].dataset["cmpVimeoDialogLayoutOption"];
